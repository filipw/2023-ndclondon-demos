...
entry:
  ...
  call void @Microsoft__Quantum__Canon___6db83253bbdc49b091c66a11d8fedab8_ApplyToEach__body(%Callable* %0, %Array* %qubits)
...
define internal void @Microsoft__Quantum__Canon___6db83253bbdc49b091c66a11d8fedab8_ApplyToEach__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___18424d4f63f64d8bb7a44cb319c1ac9c_IndexRange__body(%Array* %register)
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___6f5d4a5286094947a3aed724b9fca6f8_ForEach__body(%Callable* %0, %Array* %targets)
  call void @__quantum__rt__array_update_alias_count(%Array* %targets, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
...
define internal %Array* @Microsoft__Quantum__Arrays___6f5d4a5286094947a3aed724b9fca6f8_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
define internal %Array* @Microsoft__Quantum__Arrays___a9bc66ab19e84d9bb5345cde7388e245_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
  %retval = alloca %Array*, align 8
...
define internal %Range @Microsoft__Quantum__Arrays___18424d4f63f64d8bb7a44cb319c1ac9c_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___a9bc66ab19e84d9bb5345cde7388e245_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
